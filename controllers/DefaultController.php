...
namespace system\modules\gen\controllers;
...
class DefaultController extends Controller
{
    ...
    /**
     * @var \system\modules\gen\Module
     */
    public $module;
    /**
     * @var \system\modules\gen\Generator
     */
    public $generator;
     ...
     * @return \system\modules\gen\Generator the loaded generator
    	...
    	switch ($post['action']){
		    case 'get_module_tables':
		    	...
		    	foreach($tables as  $table){
		    		if (strpos( $table, 'module_'.$moduleID)===0){
		    			$outpot.=$table.'|';
				    }
			    }
	        break;
