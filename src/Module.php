...
{
	public $controllerNamespace='YiiMan\gen\controllers';
	public $name='setting';
	public $nameSpace='YiiMan\gen';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'YiiMan\gen\console\GenerateController',
...
//        }
    ...
    {
        return [
            'model' => ['class' => 'YiiMan\gen\generators\model\Generator'],
            'crud' => ['class' => 'YiiMan\gen\generators\crud\Generator'],
            'controllers' => ['class' => 'YiiMan\gen\generators\controller\Generator'],
            'form' => ['class' => 'YiiMan\gen\generators\form\Generator'],
            'module' => ['class' => 'YiiMan\gen\generators\module\Generator'],
            'extension' => ['class' => 'YiiMan\gen\generators\extension\Generator'],
            'basemodules' => ['class' => 'YiiMan\gen\generators\basemodule\Generator'],
        ];
    }
