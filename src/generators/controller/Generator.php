...
namespace YiiMan\gen\generators\controller;
 ...
 * @property string $controllerSubPath The controllers sub path. This property is read-only.
 *
...
class Generator extends \YiiMan\gen\Generator
{
    ...
    {
        return 'The controllers has been generated successfully.' . $this->getLinkToTry();
    }

    /**
     * This method returns a link to try controllers generated
    ...
    /**
     * This method will return sub path for controllers if it
     * is located in subdirectory of application controllers dir
     * @see https://github.com/yiisoft/yii2-gii/issues/182
     * @since 2.0.6
     * @return string the controllers sub path
     */
