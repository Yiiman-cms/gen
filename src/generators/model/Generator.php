...
namespace YiiMan\gen\generators\model;
...
class Generator extends \YiiMan\gen\Generator
{
    ...
    public function generateRules($table)
    {
        ...
        foreach ($table->foreignKeys as $refs) {
            ...
            $rules[] = "[['$attributes'], 'exist', 'skipOnError' => true, 'targetClass' =>$namespace$refClassName::className(), 'targetAttribute' => [$targetAttributes]]";
        }
...
//                var_dump($className);
                ...
                foreach ($table->foreignKeys as $refs) {
                    ...
                    $this->relations[$table->fullName][]=['link'=>$refs,'table'=>$refTable,'class'=>$refClassName];
